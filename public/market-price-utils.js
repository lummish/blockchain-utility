...
var polyfillChartData = function(chartData,interval){
...
var parseToPairs = function(interval, callback) {
    return function(unparsed_pairs) {
        var filled_data = polyfillChartData(unparsed_pairs, interval);
